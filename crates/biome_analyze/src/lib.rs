...
impl<'a> RuleFilter<'a> {
    ...
    /// Non-generic core of [Self::match_group], so callers monomorphized per
    /// rule or per group only contribute the name lookup.
...
impl<'analysis> AnalysisFilter<'analysis> {
    ...
    /// Non-generic core of [Self::match_group], so callers monomorphized per
    /// group only contribute the category and name lookups.
    ...
    /// Non-generic core of [Self::match_rule], so callers monomorphized per
    /// rule only contribute the category and name lookups.
